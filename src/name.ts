...
const PROMPT = `
You are tasked with analyzing  the provided code snippet. provide the suitable name for the function / method / class depends on what code does
`;


export async function generateName() {
    vscode.window.showInformationMessage('Generating name...');
